...
public class VoiceStyleEvent  implements Observer  ,  PreferenceCallBack , OnInitListener
{
	ImageView imageView;
	TextView  textView;
	ProxyView proxyView;
	...
	View.OnClickListener dialogClickListener = new View.OnClickListener() 
   {
		public void onClick(View arg0) 
		{
			...
			intent.putExtra(UTIL_GEO.EXTRA_PROMPT, proxyView.getActivity().getString(R.string.rec_lable_style));
	...
	public VoiceStyleEvent(View imageView , View textView) 
	{
		super();
